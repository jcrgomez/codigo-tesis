...
escaños <- c(31,5,121,7,1,7,6,1,1,137,33)
complejo <- c("A","B","C","D","E","F","G","H","I","J","K",
              "IJ","IH","BC","EA","JH","IF","DJ","IB",
              "EC","GF","FC","EG","GA","EF","FA","IC","EI",
              "EFC","EGA","IJH","GFA","IBC","EFA","EGF",
              "EIF","IFC","EIC","EGFA","EIFC")
...
round(normalized_k_valor(y)/sum(escaños),2)
